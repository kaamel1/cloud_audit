...
class TransitGatewayAssetCollector:
    ...
    def get_all_transit_gateway_assets(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: 所有传输网关及高级网络资产信息
        """
        logger.info("获取所有传输网关及高级网络资产信息")
        ...
        # 记录摘要信息
        logger.info(f"已获取 {len(cen_instances)} 个云企业网实例, {len(physical_connections)} 个物理专线, {len(vpn_gateways)} 个VPN网关")
